...
public class DriveTrain extends SubsystemBase {
  ...
  private static final CANSparkMax lf = new CANSparkMax(1, MotorType.kBrushless); // this is wrong
  private static final CANSparkMax lb = new CANSparkMax(2, MotorType.kBrushless);
  private static final CANSparkMax rf = new CANSparkMax(3, MotorType.kBrushless);
  private static final CANSparkMax rb = new CANSparkMax(4, MotorType.kBrushless);
